...
export const deportees = [
  ...
  },
  {
    ...
    dates: "Inconnue",
    photo: "",
    summary: "Résistant français, déporté à Neuengamme",
    description: "Résistant français déporté au camp de concentration de Neuengamme, près de Hambourg.",
    path: [
      {
        id: "rolland-france",
        label: "Arrestation",
        ...
        date: "1944",
        type: "origin",
        description: "Arrêté pour activités de résistance."
      },
      {
      ...
      },
      {
        ...
        date: "1944-1945",
        type: "camp",
        description: "Camp de concentration près de Hambourg. Plus de 42 000 détenus y trouvèrent la mort."
      }
    ],
    color: "#ec4899",
    campId: "neuengamme",
