          ...
          <div className=\"space-y-12\">
            ...
            <div className=\"flex items-center gap-8\">
              ...
              <div className=\"w-1/2\">
                ...
                <p className=\"text-sm text-blue-600\">Après la défaite, identifié par Franco</p>
              </div>
            </div>
            ...
            <div className=\"flex items-center gap-8\">
              <div className=\"w-1/2 text-right\">
                ...
                <p className=\"text-xs text-blue-600 mt-1\">Organisation de réseaux dans le Sud-Ouest</p>
              </div>
              <div className=\"relative z-10\">
                <div className=\"w-4 h-4 bg-amber-400 rounded-full border-4 border-white shadow\"></div>
              </div>
            ...
            <div className=\"flex items-center gap-8\">
              ...
              <div className=\"w-1/2 bg-red-50 p-4 rounded-lg\">
                ...
                <p className=\"text-sm text-red-600\">Septembre à Toulouse</p>
            ...
            <div className=\"flex items-center gap-8\">
              ...
              <div className=\"w-1/2 bg-green-50 p-4 rounded-lg\">
                ...
                <p className=\"text-sm text-green-600\">Retour à Toulouse</p>
                <p className=\"text-xs text-green-600 mt-1\">Serment de Buchenwald</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className=\"bg-slate-900 text-white py-12 px-8\">
        <div className=\"max-w-4xl mx-auto text-center\">
          <p className=\"text-xl italic mb-4\">
            \"Ce résistant déporté partiellement remarquable semble tomber dans les oubliettes de l'Histoire... D'autant plus étonnant peut-être, qu'il fut à nouveau maltraité puis après la libération de l'Europe.\"
          </p>
          <p className=\"text-sm text-amber-400\">
            - Extrait sur les résistants espagnols, important épisode méconnu de la résistance européenne dans le sud-ouest
          </p>
        </div>
      </div>
        ...
        <div className=\"max-w-6xl mx-auto\">
          ...
          <div className=\"grid md:grid-cols-3 gap-6\">
            ...
            <div className=\"bg-gray-50 border-l-4 border-gray-500 p-6 rounded-lg\">
              ...
              <p className=\"text-sm text-gray-700\">
                Le 30 juin 1951, on perd sa trace sur le bateau \"Castel\", vers la Pologne, son sort reste inconnu.
              </p>
            </div>
          </div>
        </div>
