  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 italic">"Des hommes vivants étaient déchiquetés par des chiens dressés."</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-amber-400 font-bold mb-3">L'ampleur du massacre</h3>
                  <p className="text-gray-300 italic">
                    "Dans le courant du mois de février, mille de mes camarades tombaient chaque jour à Mauthausen."
                  </p>
                  <p className="text-gray-400 text-sm mt-2">Chiffre choc qui souligne le caractère industriel de la mort.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 p-6 rounded-lg border-l-4 border-green-500">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-green-400 font-bold mb-3">La dignité et la résistance morale des survivants</h3>
                  <p className="text-gray-300 italic">
                    "Nous n'avons jamais désespéré ; nous avons tous fait dans nos cœurs le serment de venger tous nos morts."
                  </p>
                  <p className="text-gray-400 text-sm mt-2">Moment très fort : malgré l'horreur, il y a la volonté de mémoire et de justice.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-blue-400 font-bold mb-3">L'appel politique et moral</h3>
                  <p className="text-gray-300 italic mb-2">
                    "Unissons-nous toujours davantage pour écraser les survivances du fascisme qui règnent encore en France et dans le monde."
                  </p>
                  <p className="text-gray-300 italic">
                    "Faire le serment […] que soient écartées les horreurs d'une guerre nouvelle."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-8">
              <p className="text-2xl font-bold text-amber-400">"Vive la France."</p>
              <p className="text-gray-400 text-sm mt-2">Cri final qui associe mémoire, résistance et espoir.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">L'Après-Guerre et l'Héritage</h2>

          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                <Award className="w-6 h-6 text-green-600" />
                <h3 className="font-bold text-gray-800">Retour difficile</h3>
              </div>
              <p className="text-sm text-gray-700">
                Le 5 mai 1945, Georges Séguy rentre à Toulouse pesant 38 kilos. Il "a du mal à refaire surface" selon ses propres termes.
              </p>
            </div>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-6 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-gray-800">Séquelles</h3>
              </div>
              <p className="text-sm text-gray-700">
                Après un mois de repos, il doit renoncer au métier de typographe, incompatible avec les séquelles de sa pleurésie.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-gray-800">Engagement syndical</h3>
              </div>
              <p className="text-sm text-gray-700">
                Il devient Secrétaire général de la CGT de 1967 à 1982, figure emblématique du syndicalisme français.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-slate-900 text-white py-12 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-amber-400">
            - Georges Séguy, témoignage sur Mauthausen
          </p>
        </div>
      </div>

      {/* Sources */}
      <div id="sources" className="py-16 px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Sources et Bibliographie</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Dictionnaire Maitron : maitron.fr/seguy-georges-gervais/</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>CGT Histoire : cgt.fr/actualites/histoire/georges-seguy-figure-emblematique-du-syndicalisme-francais</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Archives Arolsen : collections.arolsen-archives.org</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Témoignage élèves : maquisdelorris.fr/resistance/</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Georges SÉGUY, <em>Résister de Mauthausen à mai 1968</em></span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Livre mémorial de la déportation</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Notice du dictionnaire <em>Cheminots et militants</em> par Michel Dreyfus</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600">•</span>
                  <span>Service historique de la Défense, Caen - AC 21 P 673598</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 bg-amber-50 p-6 rounded-lg">
            ...
            <p className="text-sm text-gray-700">
              Les archives Arolsen indiquent que Georges Séguy mentait sur sa date de naissance (12/5/05 ou 8/5/05 ou 28/4/1911) et possiblement son lieu de résidence (Aix sur Vienne) pour protéger son identité durant la période de résistance.
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-slate-900 text-white py-8 px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm mb-1">
            En mémoire de Georges Séguy et de tous les résistants déportés.
          </p>
          <p className="text-gray-500 text-xs">1927 - 1982 • Que leur sacrifice ne soit jamais oublié</p>
          <p className="text-gray-600 text-xs mt-2">Octobre 1945 - Sources consultées le 16/02/2026</p>
        </div>
      </footer>
    </div>
  );
